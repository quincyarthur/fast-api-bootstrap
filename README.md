...
5. Why does the Authorize button in the docs fail?

> Honestly, I'm not 100% sure. I belive it has something to do with using both JWTBearer and the OAuthPasswordBearer authorization strategies. I was unable to find a resolution online. As a workaround, the autogenerated docs can be used for just that (documentation). Postman is used to send to actually interact with the API.
